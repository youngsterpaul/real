        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <div className="divide-y divide-border">
              ...
              return <button key={item.path} onClick={() => navigate(item.path)} className="w-full flex items-center justify-between p-6 hover:bg-accent transition-colors">
              ...
              <button onClick={handleLogout} className="w-full flex items-center justify-between p-6 hover:bg-accent transition-colors">
                <div className="flex items-center gap-4">
